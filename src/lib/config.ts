...
import * as shared from "../sdk/models/shared/index.ts";
import { HTTPClient } from "./http.ts";
import { Logger } from "./logger.ts";
import { RetryConfig } from "./retries.ts";
import { Params, pathToFunc } from "./url.ts";
...
export const SDK_METADATA = {
  ...
  genVersion: "2.493.13",
  userAgent:
    "speakeasy-sdk/typescript 0.19.0 2.493.13 1.0.58 unstructured-client",
} as const;
